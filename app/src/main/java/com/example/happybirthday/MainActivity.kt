        ...
        setContent {
            HappyBirthdayTheme {
                ...
                Surface(
                    ...
                    GreetingImage(message = stringResource(R.string.happy_birthday_aryan), from ="From Aryan", modifier = Modifier.padding(8.dp))
...
fun BirthdayCardPreview() {
    HappyBirthdayTheme {
        GreetingImage(message = stringResource(id = R.string.happy_birthday_aryan),
